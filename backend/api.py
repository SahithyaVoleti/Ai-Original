...
def download_report():
    ...
    if success and os.path.exists(filepath):
        ...
        return jsonify({
            ...
            "details": f"Internal Error: {error_msg if 'error_msg' in locals() else 'Check server logs'}. This can happen if the interview was not properly finished or if there were internal generation errors (e.g., division by zero)."
        }), 500
